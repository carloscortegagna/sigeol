		...
		function () {
			...
			if (!jQuery('#ptTimeSelectCntr').length) {
				jQuery("body").append(
					...
					+	'							<div class="ptTimeSelectHrAmPmCntr" style="display:none;">'
				...
				$(document).focus(jQuery.ptTimeSelect._doCheckMouseClick);
			}//end if
		}
	);
...
jQuery.ptTimeSelect.openCntr = function (ele) {
	...
	cntr.find("#ptTimeSelectUserSelAmPm").empty().append('');
