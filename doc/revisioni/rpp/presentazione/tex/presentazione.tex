...
\begin{Large}\textbf{View}\end{Large}
	\begin{center}
 \includegraphics[scale=0.33]{images/diagramma_componenti_view.pdf}
...
\begin{Large}\textbf{Controller}\end{Large}
	\begin{center}
 \includegraphics[scale=0.33]{images/diagramma_componenti_controller.pdf}
\end{center}
 \transsplitverticalin
}\frame{
 \frametitle{Specifica tecnica}
...
\begin{Large}\textbf{Model}\end{Large}
	\begin{center}
 \includegraphics[scale=0.33]{images/diagramma_componenti_model.pdf}
\end{center}
 \transsplitverticalin
}
\frame{
...
\begin{Large}\textbf{MiddleMan}\end{Large}
	\begin{center}
 \includegraphics[scale=0.33]{images/diagramma_componenti_middleman.pdf}
\end{center}
...
\begin{Large}\textbf{Algorithm}\end{Large}
	\begin{center}
 \includegraphics[scale=0.33]{images/diagramma_componenti_algorithm.pdf}
\end{center}
 \transsplitverticalin
}
...
\frame{
	...
	\transsplitverticalin
	\includegraphics[scale=0.2]{images/future.JPG} \\
	\begin{center}
