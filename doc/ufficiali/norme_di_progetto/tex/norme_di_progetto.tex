...
\hline
\hline
\textit{09-06-2009} & 2.0.0 & Approvazione del responsabile e passaggio in stato di Formale\\
\hline
\textit{07-06-2009} & 1.6.0 & Correzioni ortografiche varie\\
\hline
...
\thispagestyle{plain}
\title{\begin{Huge}\textsc{Progetto SIGEOL}\end{Huge} \\ \textit{Norme di Progetto \\ v2.0.0}}
\author{Redazione: Scarpa Davide}
\maketitle
\medskip
\begin{center}
