...
\lfoot{Norme di Progetto v1.1.0}
\cfoot{}
...
\thispagestyle{plain}
\title{\begin{Huge}\textsc{Progetto SIGEOL}\end{Huge} \\ \textit{Norme di Progetto \\ v1.1.0}}
...
Ogni nuova comunicazione pubblicata nella bacheca verrà notificata auto\-maticamente via e-mail a tutti membri del team QuiXoft, qualsiasi ruolo essi ricoprano; la pubblicazione della stessa, invece, spetta al \underline{Responsabile}.
