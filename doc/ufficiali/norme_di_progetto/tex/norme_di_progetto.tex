...
\lfoot{Norme di Progetto v0.1.0}
\cfoot{}
...
\thispagestyle{plain}
\title{\begin{Huge}\textsc{Progetto SIGEOL}\end{Huge} \\ \textit{Norme di Progetto \\ v0.1.0}}
...
Sarà compito del Responsabile di Progetto verificare che tali norme vengano applicate ed, eventualmente, notificare all'Amministrazione di Progetto qualsiasi insubordinazione che mini il corretto procedere del progetto.
\section{Definizioni}
...
Ogni nuova comunicazione pubblicata nella bacheca verrà notificata automaticamente via e-mail ai membri del team Quixoft.
La notifica del messaggio verrà inviata a tutti i membri, qualsiasi ruolo essi ricoprano; spetta invece solamente al Responsabile pubblicare i messaggi in bacheca.

E' messo a disposizione anche un forum per tutte le altre comunicazioni interne al team.
La struttura del forum è decisa preventivamente dall'amministratore di progetto, mentre ogni membro del team ha la possibilità di discutere di qualsiasi argomento che possa in qualsiasi modo giovare al proseguimento del progetto.
