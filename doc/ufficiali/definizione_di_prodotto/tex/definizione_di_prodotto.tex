...
\end{itemize}
Inoltre per garantire l'interoperabilità dei dati sono presenti i templates XML per tutte le azioni \verb|index| e \verb|show| autogenerati dal controller attraverso un metodo proprio di ruby on rails (to_xml).
E' presente inoltre un template PDF per l'azione \verb|show| di \verb|TimetablesController| che sfrutta il plugin RTex alla versione 2.0.1 renderizzando un documento secondo il linguaggio \LaTeX.
