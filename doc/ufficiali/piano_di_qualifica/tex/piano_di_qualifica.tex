...
\lfoot{Piano di Qualifica v0.5.1}
\cfoot{}
...
\thispagestyle{plain}
\title{\begin{Huge}\textsc{Progetto SIGEOL}\end{Huge} \\ \textit{Piano di Qualifica \\ v0.5.1}}
...
\begin{center}
\textbf{Sommario} \\
Piano di Qualifica per il progetto ''SIGEOL'', necessario per regolamentare le operazioni di verifica, validazione e controllo qualità durante il periodio di sviluppo.
\end{center}
\newpage
}
...
Particolare attenzione verrà posta anche nella definizione delle attività di verifica e validazione del materiale prodotto e, col procedere dello sviluppo, nella descrizione degli ambienti di prova e di \underline{collaudo}.
...
\begin{itemize}
	...
	\item tutti gli altri ruoli previsti all'interno del team (\underline{Analista}, \underline{Progettista}, \underline{Programmatore}, \underline{Amministratore}) sono tenuti a sottoporre il proprio lavoro al verificatore per le fasi di controllo e test. E' loro responsabilità anche apportare le modifiche che il Verificatore avrà notificato essere necessarie e che il Responsabile avrà convalidato.
\end{itemize}
