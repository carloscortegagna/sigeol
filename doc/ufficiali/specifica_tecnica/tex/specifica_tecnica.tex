...
\lfoot{Specifica tecnica v0.6.4}
\cfoot{}
...
\thispagestyle{plain}
\title{\begin{Huge}\textsc{Progetto SIGEOL}\end{Huge} \\ \textit{Specifica Tecnica \\ v0.6.4}}
...
\subsubsection{Interazione tra MiddleMan e applicazione}
\begin{flushleft}
\includegraphics[angle=90,scale=0.5]{images/middleman_seq_diagram.pdf}
\end{flushleft}% MiddleMan_sequence_diagram.png: 1364x579 pixel, 72dpi, 48.12x20.43 cm, bb=0 0 1364 579
\begin{description}
 \item[1] impostazione di una nuova generazione dell'orario ad una detterminata data
\item[1.1] impostazione della classe da istanziare all'avvio dell'evento schedulato
\item [1.1.1] segnalazione all'applicazione 
\item [1.1.1.2] invio dei dati alla servlet utilizzati per la generazione dell'orario (manuale e schedulata)
\item [1.1.1.2.1] impostazione della classe da istanziare all'avvio dell'evento schedulato
\item [1.1.1.3.1.1] avvio dell'algoritmo
\item [1.1.1.3.1.2] segnalazione della generazione dell'orario effettuata 	
 \end{description}
