...
\hline
\hline
\textit{23-01-2009} & 0.4.2 & Correzioni varie \\
\hline
\textit{23-01-2009} & 0.4.1 & Aggiunto middleman e algorithm \\
\hline
...
\begin{center}
\includegraphics[scale=0.3]{images/component_diagram.png}\end{center}
...
\subsubsection{Parte Middle Man}
Il BackgroundRb è il job server e scheduler di Ruby. 
Il suo uso principale è quello di eseguire tasks di lunga durata separatamente dal ciclo dell'http request/respons in modo da non mettere in attesa l'esecuzione dell'applicazione.

\subsubsection{Parte Algorithm}
Il componente TimeTableScheduler implementa l'algoritmo di generazione dell'orario.
...
\begin{center}
\includegraphics[scale=0.3]{images/class_diagram.png}\end{center}
