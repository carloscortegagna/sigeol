...
\lfoot{Piano di Progetto v0.4.0}
\cfoot{}
...
In linea di massima, le ore fatte in corso d'attività dovranno essere paragonabili a quelle attribuite a ciascun componente del gruppo nel piano. Il piano di progetto di fase in fase verrà aggiornato inserendo le ore consuntive di ogni ruolo. 
E' stato pianificato che ogni componente avrà un carico di lavoro poco inferiore alle 105 ore. Per maggiori informazioni andare alla sezione 4.
...
Per il calcolo di quest'ultime si sono anche utilizzate le date delle revisioni del precedente anno accademico.
...
Per questa revisione è previsto il documento contenente la classificazione e discussione dei requisiti, chiamato Analisi dei requisiti e una prima redazione del piano di qualifica. Per maggiori informazioni su questo processo di revisione 
...
Lo scopo di una revisione interna è quello di mostrare il progresso del progetto al cliente, determinando se esistono, nuovi bisogni e di identificare eventuali correzioni da fare. Questo tipo di revisione non ha effetto sanzionatorio.
...
\begin{itemize}
\item Analisi dei requisiti: mostra la definizione e classificazione dei requisiti. Il file in formato pdf del documento è nominato analisi\_dei\_requisiti.pdf. 
\item Piano di qualifica: delinea la strategia generale di verifica e validazione. Il file in formato pdf del documento è nominato piano\_di\_qualifica.pdf.  
...
Per questa fase si dovrà aggiornare il piano di qualifica,il piano di progetto e produrre un nuovo documento:
\begin{itemize}
...
Per questa fase si dovrà aggiornare il piano di qualifica, inserendo il resoconto definitivo della campagna di verifica e la descrizione delle prove proposte per il collaudo. Si dovrà poi produrre in modo parziale un nuovo documento:
\begin{itemize}
\item Manuale utente: Descrive le istruzioni per l'uso del sistema. Il file in formato pdf del documento è manuale\_utente.pdf.
\end{itemize}
...
Per questa fase si dovranno aggiornare in modo definitivo il piano di qualifica e il manuale utente.
