...
\end{center}
\bigskip
Il costo totale sostenuto fin'ora è quindi di xxxxxxx \euro. Tale costo è ancora inferiore di 13764-xxxxxx \euro al costo inizialmente preventivato.
Tale disavanzo verrà impiegato dal team per portare a termine la seconda fase di realizzazione, tutt'ora in corso.

Il costo preventivato inizialmente per la seconda fase di realizzazione è di zzzzzzzzz \euro, molto vicino quindi al valore di 13764-xxxxxx appena rilevato. Si prevede quindi di riuscire a portare a compimento il progetto restando ampiamente entro i costi preventivati.
\modifiche
\end{document}