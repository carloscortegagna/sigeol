...
\item Possibilità di impostare vincoli e preferenze per la struttura dell'orario %da sistemare
...
\item Pagine scritte in \underline{XHTML} e \underline{CSS} dovranno essere validate tramite strumenti forniti dal consorzio \underline{W3C}
\end{enumerate}
\end{itemize}
...
l'\textit{utente non autenticato} effettua l'accesso alla sua pagina personale inserendo il proprio indirizzo email nel campo 'username' e la propria password nel campo 'password'.
