...
\chead{}
\rhead{\includegraphics[scale=0.15]{logo.png}}
\lfoot{Analisi dei requisiti v1.0.1}
\cfoot{}
\rfoot{}
}
\headheight = 46pt
...
\thispagestyle{plain}
\title{\begin{Huge}\textsc{Progetto SIGEOL}\end{Huge} \\ \textit{Analisi dei requisiti \\ v1.0.1}}
...
\begin{itemize}
 ...
 \item Informativa sulla privacy (Legge per    quisiti                                                             15
4.1 RF. Requisiti funzionali . . . . . . . . . . . . . . . . . . . . . 16
    4.1.1
...
\item RFO0.4 Possibilità di inserimento e modifica per ogni aula disponibile, all'interno della propria facoltà, del nome, della capienza, delle ore e dei periodi di non disponibilità
\item RFO0.5 Possibilità di inserimento e modifica dei dati relativi all'anno accademico
...
\item RFO0.9 Possibilità di inserimento e modifica dei diversi indirizzi appartenenti allo stesso corso di laurea
\item RFO0.10 Possibilità di ripristinare i dati relativi ai corsi di laurea da un \underline{backup} scelto
\item RFO0.11 Possibilità di scegliere lo stato (rilassato o meno) dei vincoli, eventualmente modificati dal sistema al fine di generare uno schema d'orario nel caso in cui esso risulti inesistente
\item RFO0.12 Possibilità di notificare i vincoli e le preferenze non soddisfatti ai docenti interessati
\item RFO0.13 Possibilità di consultare le informazioni relative a docenti, aule, corsi di laurea e corsi
\end{enumerate}
...
\item RFD0.1 Possibilità di impostare una data limite per l'inserimento dei vincoli da parte dei docenti, con notifica della scadenza. \item RFD0.2 Possibilità di modifica manuale dello schema d'orario specificato
\end{enumerate}
\end{itemize}
...
\item \textbf{OBBLIGATORI}
\begin{enumerate}
\item RF10.0 Possibilità di \underline{autenticazione}
\item RF10.1 Possibilità di inserimento e modifica per ogni corso, all'interno del proprio corso di laurea, del nome, dei relativi CFU, dell'anno di appartenenza, del periodo, dello stato, del numero di ore in aula e in laboratorio (se previsto), del docente di riferimento che lo tiene, di eventuali assistenti e della stima del numero di studenti che lo seguiranno
\item RF10.2 Possibilità di inserimento e modifica per ogni aula disponibile, all'interno del proprio corso di laurea, del nome, della capienza, delle ore e dei periodi di non disponibilità
\item RF10.3 Possibilità di inserimento e modifica, all'interno del proprio corso di laurea, dei dati dei docenti
\item RF10.4 Possibilità di inserimento e modifica per ogni aula disponibile, all'interno della propria facoltà, del nome, della capienza, delle ore e dei periodi di non disponibilità
\item RF10.5 Possibilità di inserimento e modifica dei dati relativi all'anno accademico
\item RF10.6 Possibilità di impostare vincoli e le preferenze per la struttura dell'orario
\item RF10.7 Possibilità di generazione dello schema d'orario in formato \underline{pdf} e \underline{html}
\item RF10.8 Possibilità di consultare lo schema d'orario di ogni corso di laurea
\item RF10.9 Possibilità di inserimento e modifica dei diversi indirizzi appartenenti allo stesso corso di laurea
\item RF10.10 Possibilità di ripristinare i dati relativi ai corsi di laurea da un \underline{backup} scelto
\item RF10.11 Possibilità di scegliere lo stato (rilassato o meno) dei vincoli, eventualmente modificati dal sistema al fine di generare uno schema d'orario nel caso in cui esso risulti inesistente
\item RF10.12 Possibilità di notificare i vincoli e le preferenze non soddisfatti ai docenti interessati
\item RF10.13 Possibilità di consultare le informazioni relative a docenti, aule, corsi di laurea e corsi
\end{enumerate}
\item \textbf{DESIDERABILI}
\begin{enumerate}
\item RFD1.0 Possibilità di notificare il mancato inserimento di un docente o di un corso d'insegnamento di un altro corso di laurea
\item RFD1.1 Possibilità di impostare una data limite per l'inserimento dei vincoli da parte dei docenti, con notifica della scadenza. \item RFD1.2 Possibilità di modifica manuale dello schema d'orario specificato
\end{enumerate}
\end{itemize}
...
\item RFO2.1 Possibilità di inserimento e modifica delle proprie preferenze su orari e giorni di lezione
\item RFO2.1 Possibilità di modifica dei propri dati personali
\end{enumerate}
\item \textbf{DESIDERABILI}
\begin{enumerate}
\item RFO2.1 Possibilità di consultare le informazioni relative a docenti, aule, corsi di laurea e corsi d'insegnamento
\end{enumerate}
\end{itemize}
...
\item RFO3.1 Possibilità di consultare le informazioni relative a docenti, aule, corsi di laurea e corsi d'insegnamento
\end{enumerate}
\end{itemize}
...
\item RIO1.3 Al fine di evitare errori e reinserimenti manuali il sistema dovrà il più possibile proporre all'utente i dati in modo automatico
\end{enumerate}
\end{itemize}
