...
\lfoot{Manuale Installazione v0.1.0}
\cfoot{}
...
\thispagestyle{plain}
\title{\begin{Huge}\textsc{Progetto SIGEOL}\end{Huge} \\ \textit{Manuale Installazione\\ v0.1.0}}
...
\begin{center}
\textbf{Sommario} \\
Manuale per l'installazione del prodotto \textit{SIGEOL} , contenente la spiegazione dell'installazione, dei possibili problemi e delle relative soluzioni.
\end{center}
\newpage
}
